...
public:
   ...
   */
  enum IsotropicRefinementChoices : std::uint8_t
  {
    /**
  ...
  all_isotropic_refinement_choices() const;
  ...
  /**
   * Return a vector of vertex indices for the faces of the reference cell.
   */
  constexpr dealii::ndarray<unsigned int, 4, 3>
  reference_cell_face_vertices() const;
...
constexpr dealii::ndarray<unsigned int, 4, 3>
ReferenceCell::reference_cell_face_vertices() const
{
  switch (this->kind)
    {
      case ReferenceCells::Tetrahedron:
        {
          constexpr dealii::ndarray<unsigned int, 4, 3>
            reference_cell_face_vertices_tet = {
              {{{0, 1, 2}}, {{1, 0, 3}}, {{0, 2, 3}}, {{2, 1, 3}}}};
          return reference_cell_face_vertices_tet;
        }
      default:
        DEAL_II_NOT_IMPLEMENTED();
    }
...
ReferenceCell::all_isotropic_refinement_choices() const
{
  switch (this->kind)
    {
      case ReferenceCells::Vertex:
      ...
      case ReferenceCells::Quadrilateral:
        return {0};
      case ReferenceCells::Tetrahedron:
        return {ReferenceCell::cut_tet_68,
                ReferenceCell::cut_tet_57,
                ReferenceCell::cut_tet_49};
      case ReferenceCells::Pyramid:
  ...
  switch (this->kind)
    {
      ...
      case ReferenceCells::Tetrahedron:
        {
          return this
            ->reference_cell_face_vertices()[face][standard_to_real_face_vertex(
