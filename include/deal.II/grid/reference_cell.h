          ...
          constexpr dealii::ndarray<unsigned int, 3, 12, 4> new_quad_lines_tet =
            {{// new line is (6,8)
              ...
              {{{{2, 3, 8, X}},
                ...
                {{X, X, X, X}},
                {{X, X, X, X}}}}}};
          constexpr dealii::ndarray<unsigned int, 3, 12, 4>
            new_quad_lines_tet_old = {{// new line is (6,8)
                                       {{{{2, 3, 8, X}},
                                         {{0, 9, 5, X}},
                                         {{1, 6, 11, X}},
                                         {{4, 10, 7, X}},
          ...
          constexpr dealii::ndarray<unsigned int, 3, 12, 4, 2> table_tet = {
            {// new line is (6, 8)
             ...
             {{{{{{6, 4}}, {{4, 7}}, {{7, 6}}, {{X, X}}}},
               ...
               {{{{X, X}}, {{X, X}}, {{X, X}}, {{X, X}}}},
               {{{{X, X}}, {{X, X}}, {{X, X}}, {{X, X}}}}}}}};
          constexpr dealii::ndarray<unsigned int, 3, 12, 4, 2> table_tet_old = {
            {// new line is (6, 8)
             {{{{{{6, 4}}, {{4, 7}}, {{7, 6}}, {{X, X}}}},
               {{{{4, 5}}, {{5, 8}}, {{8, 4}}, {{X, X}}}},
               {{{{5, 6}}, {{6, 9}}, {{9, 5}}, {{X, X}}}},
      ...
      case ReferenceCells::Tetrahedron:
        {
          ...
          constexpr dealii::ndarray<unsigned int, 3, 8, 6> cell_quads_tet_old =
            {{// new line is (6, 8)
              {{{{8, 13, 16, 0, X, X}},
                {{9, 12, 1, 21, X, X}},
                {{10, 2, 17, 20, X, X}},
          ...
          constexpr dealii::ndarray<unsigned int, 3, 8, 4> cell_vertices_tet = {
            {// new line is (6,8)
             ...
             {{{{0, 4, 6, 7}},
               ...
               {{4, 9, 7, 8}},
               {{8, 5, 4, 9}}}}}};
          constexpr dealii::ndarray<unsigned int, 3, 8, 4>
            cell_vertices_tet_old = {{// new line is (6,8)
                                      {{{{0, 4, 6, 7}},
                                        {{4, 1, 5, 8}},
                                        {{6, 5, 2, 9}},
                                        {{7, 8, 9, 3}},
