...
template <int dim, int spacedim>
FiniteElementDomination::Domination
FE_WedgeDGP<dim, spacedim>::compare_for_domination(
  const FiniteElement<dim, spacedim> &fe_other,
  const unsigned int                  codim) const
{
  Assert(codim <= dim, ExcImpossibleInDim(dim));
...
template <int dim, int spacedim>
std::vector<std::pair<unsigned int, unsigned int>>
FE_WedgeDGP<dim, spacedim>::hp_vertex_dof_identities(
...
template <int dim, int spacedim>
std::vector<std::pair<unsigned int, unsigned int>>
FE_WedgeDGP<dim, spacedim>::hp_line_dof_identities(
  const FiniteElement<dim, spacedim> &) const
{
  return {};
}
...
template <int dim, int spacedim>
std::vector<std::pair<unsigned int, unsigned int>>
FE_WedgeDGP<dim, spacedim>::hp_quad_dof_identities(
