      ...
      if (total_cells > tria_level.refine_flags.size())
        {
          ...
          tria_level.refine_choice.insert(
            ...
            /*ReferenceCell::isotropic_refinement=*/0);
...

                {
                  ...
                  if (reference_cell_type == ReferenceCells::Hexahedron)
                  ...
                  else if (reference_cell_type == ReferenceCells::Tetrahedron)
                    {
                      ...
                      std::uint8_t refinement_choice = hex->refine_choice_set();
                      if (refinement_choice ==
                          ReferenceCell::isotropic_refinement)
                        {
                      ...
                      else if (refinement_choice == ReferenceCell::cut_tet_68)
                        chosen_line_tetrahedron = 0;
                      else if (refinement_choice == ReferenceCell::cut_tet_57)
                        chosen_line_tetrahedron = 1;
                      else if (refinement_choice == ReferenceCell::cut_tet_49)
                      ...
                      switch (chosen_line_tetrahedron)
                        {
                          case 0:
                            hex->set_refinement_case(
                              RefinementCase<dim>(ReferenceCell::cut_tet_68));
                            break;
                          case 1:
                            hex->set_refinement_case(
                              RefinementCase<dim>(ReferenceCell::cut_tet_57));
                            break;
                          case 2:
                            hex->set_refinement_case(
                              RefinementCase<dim>(ReferenceCell::cut_tet_49));
                            break;
                        }
                            ...
                            for (const auto f : new_hex->face_indices())
                              {
                                ...
                                // the 4 faces of the reference tet are defined
                                // by 3 vertices each and follow the order of
                                // the unit cell
